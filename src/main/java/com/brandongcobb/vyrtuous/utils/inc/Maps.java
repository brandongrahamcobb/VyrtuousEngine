...
public class Maps {
    ...
    public static final String OPENAI_RESPONSE_SYS_INPUT = FileObject.ACTIVITY_OBJECT + " | " + FileObject.AI_MANAGER + " | " + FileObject.CONFIG_MANAGER + " | " + FileObject.COST_OBJECT + " | " + FileObject.DISCORD_BOT + " | " + FileObject.EVENT_LISTENERS + " | " + FileObject.HELPERS + " | " + FileObject.HYBIRD_COMMANDS + " | " + FileObject.METADATA_CONTAINER + " | " + FileObject.METADATA_HOLDER + " | " + FileObject.METADATA_KEY + " | " + FileObject.METADATA_TYPE + " | " + FileObject.MESSAGE_MANAGER + " | " + FileObject.MODEL_INFO + " | " + FileObject.MODEL_REGISTRY + " | " + FileObject.MODERATION_MANAGER + " | " + FileObject.PREDICATOR + " | " + FileObject.REQUEST_OBJECT + " | " + FileObject.RESPONSE_OBJECT + " | " + FileObject.VYRTUOUS;
