...
import com.brandongcobb.lucy.utils.handlers.DiscordUser;
import com.brandongcobb.lucy.utils.handlers.MinecraftUser;
...
public class OAuthUserSession {
    ...
    public OAuthUserSession(Lucy application, MinecraftUser minecraftUser, String accessToken) {
    ...
    public OAuthUserSession(Lucy application,  DiscordUser discordUser, String accessToken) {
        this.app = application;
        this.accessToken = accessToken;
    }
